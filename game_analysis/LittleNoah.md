...
### シリーズファン
本作は2019年にサービス終了した「リトルノア」シリーズの最新作でがゲームから得た気づきをまとめる
...
## 2.おもしろさのポイント
このゲームで倒されてしまった場合、いくらレアな装備やアストラルを持っていたとしてもただのマナへと変換されてしまうという無慈悲な仕様となっています。\
ただ私はこの無慈悲な仕様こそがこのゲームの面白さの核心だと考えました。\
...
### シリーズファン
本作のリトルノアは前作の「リトルノア」ファンを意識した工夫がされています。\
工夫されている点としてアートディレクターが挙げられます。\
前作のリトルノアのアートディレクターは吉田明彦さんという方が担当されていて、今作のリトルノアも担当されています。\
これは、「前作の世界観や設定なども楽しんでもらいたい！」というファンに向けた思いが込められていると感じることができました。\

### アクションゲーム好き(初心者から上級者)
本作はアクションゲームとしての爽快感と達成感の二つを併せ持ちつつも初心者から上級者まで楽しめる設計が二つされていました。\
一つ目は難易度選択です。今作はeasy、normal,hardの3つの難易度でゲームを遊べるように設定されておりアクションゲームが苦手な方でも楽しめるようになっています。\
また、難易度はゲーム中にも変更することができ、「装備などの強化をしてからhardに挑む」のような多様な遊び方ができるように工夫がされています。
二つ目は強化設計です。このゲームの強化要素は非常に強力なものに設定されており強化をすれば勝てるといった設計となっています。\
つまりこれはアクションゲーム初心者でも続ければ必ずクリアできるということになります。上級者でスリルを楽しみたい人は強化をしなくていいし、初心者でアクションゲームが苦手という人は強化をすればよい。\
この強化設計は、初心者から上級者まで自分のレベルに応じた幅広い選択をすることができ、快適にゲームをプレイできることを可能にしています。\

## 4.まとめ
今作はシンプルなゲームループながらもやりごたえのあるゲーム体験を提供することに成功させている。\
やりごたえという面を併せ持ちつつも初心者の配慮も欠かせない設計となっており幅広いユーザーが楽しめる作品となっていた。\
また、前作の世界観を壊さないというシリーズファンへの配慮も欠かせなかった。
