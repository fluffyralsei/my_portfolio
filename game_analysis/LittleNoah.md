...
### リスクとリターン
前述のとおりこのゲームで倒されてしまった場合、探索で手に入れたアイテムはすべてマナに変換されます。\
そのため、探索を進めば進むほど集めたアイテムを失うリスクが高まるという設計になっています。\
<br>
ゲームにおいてリスクとはリターンを得るために必要な「危険な行為」と考えています。\
今回のゲームのリスクとは「レアアイテムを全部失ってしまうのにも関わらず探索する」ということで、リターンは「ゲームの進行度」と「マナ」となっています。\
